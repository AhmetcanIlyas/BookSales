...
<%  
    ...
    String soru = dbkatmani.getGuvenlikSoru(email);
%>
<body>
    <header>
        <div class="logo">
    ...
    <div class="content">
        ...
        <div class="login-panel">
            ...
            <form method="post" onsumbit="return giris()"> 
                <h4><%=soru%></h4>
                <input type="text" name="cevap" placeholder="Güvenlik Sorusu Cevabı" required>
...
<script>
    function kontrol(){
        <%
            String girdi = request.getParameter("cevap");
            String cevap = dbkatmani.getGuvenlikCevap(email);
            if(girdi!=null){
                if(girdi.equals(cevap)){
                response.sendRedirect("yeniSifre.jsp");
                }else{
                    response.sendRedirect("guvenlik.jsp");
                    }
            }
        %>
    }
