...
<head>
    ...
    <title>KitabiX - Şifremi Unuttum</title>
    <style>
...
<body>
    ...
    <div class="content">
        ...
        <div class="login-panel">
            ...
            <form method="post"> <!-- Gerçek şifre sıfırlama işlemi için '#' yerine uygun URL'yi kullanın -->
                <input type="email" name="email" placeholder="E-posta Adresi" required>
                <button type="submit" onclick="kontrol()" >Şifremi Sıfırla</button>
            </form>
            <p><a href="uyePaneli.jsp">Giriş Yap</a></p> <!-- Giriş yapma sayfasının URL'sini kullanın -->
            <p><a href="uyeOl.jsp">Kayıt Ol</a></p> <!-- Üye olma sayfasının URL'sini kullanın -->
        </div>
    </div>
    ...
    <script>
        function kontrol(){
            ...
            String yanit = dbkatmani.getKontrol(email);
            if(yanit=="0"){
                response.sendRedirect("uyariMail2.jsp"); 
                }
            else if(yanit=="1"){
                response.sendRedirect("sifreSifirla.jsp");
