...
<head>
    ...
    <title>KitabiX - Kategoriler</title>
    <style>
...
<body>
    ...
    <nav>
        ...
        <% List<String> listeVerisi = dbkatmani.getKategoriListesi(); %>
    </ul>

    <div class="container">
        <% for (String veri : listeVerisi) { %>
        <div class="book-card">
            <div class="book-card-content">
                <h3><a href="kitaplar.jsp?bilgi=<%=(veri)%>"><%=(veri)%></a></h3>   
            </div>
        </div>
        <% } %>
    </div>
